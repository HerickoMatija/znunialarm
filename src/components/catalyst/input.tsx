...
export interface InputProps extends React.ComponentPropsWithoutRef<'span'> {
  clickableIcon?: boolean
}

export function InputGroup({ clickableIcon = false, children }: InputProps) {
  return (
    <span
      data-slot="control"
      className={clsx(
        ...
        clickableIcon ? '' : '[&>[data-slot=icon]]:pointer-events-none'
      )}
    >
      {children}
    </span>
