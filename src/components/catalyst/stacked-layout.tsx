...
export function StackedLayout({
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full flex-col bg-white lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      ...
      {/* Content */}
      {renderMain({ isLandingPage, children })}
...
function renderMain({ isLandingPage, children }: React.PropsWithChildren<{ isLandingPage: boolean }>) {
  if (isLandingPage) {
    return <main className="mx-auto flex w-full flex-1 flex-col pb-2 lg:px-2">{children}</main>
  } else {
    return (
